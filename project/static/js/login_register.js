...
$(document).ready(function () {
    ...
    $( "#register_form" ).on( "submit", function(event) {
        ...
        if (!validate_inputs(first_value, lastname_value, date_value, tel, id_number, emailValue, user_name, password_value, password2_value)) {
            return
        } 
...
function validate_inputs(first_value, lastname_value, date_value, tel, id_number, emailValue, user_name, password_value, password2_value) {
    var total = 0
...
/* validate Input */
function validate_duplicate_data_and_submit_form(id_number, emailValue, user_name) {
